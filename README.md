...
|---|---|---|
| **Naive Bayes** | Multinomial, alpha = 1.0 (Laplace smoothing) | Fast probabilistic baseline |
...
> **Note:** All metrics above are extracted from the actual experimental results reported in the [project report](report/datamining_report.pdf) (Table 5.1). Full metrics including Accuracy, Precision, Recall, and cross-validation scores are available in the report.
...
> **Note:** This repository contains the academic report PDF. The underlying Python notebooks, source code, and figures described in the report are not included in this public repository. The full methodology, code snippets, and results are documented in the report.
